...
public class Utils<E> {
	...
	/**
	 * Erzeugt alle m&ouml;glichen 2er-Kombinationen aus einer Liste von
	 * Objekten
	 *
	...
	/**
	 * Gibt
	 * <code>number</code> Samstage ab
	 * <code>start</code> zur&uuml;ck
	 *
	 * @param startSaturday erster Samstage (z. B. 11.02.12)
	 * @param number Anzahl an ben&ouml;tigten Samstagen + Sonntage (bei
	 * ungerader Zahl ist letztes Datum ein Samstag)
	 * @return
	 * <code>number</code> Samstage + Sonntage, inklusive
	 * <code>start</code>
	 * @throws ParseException wenn falsches Format oder
	 * <code>start</code> kein Samstag
	 */
	...
	public static ArrayList mix(ArrayList src) {
		...
		while (!src.isEmpty()) // ...wird das Element an einer zufälligen Stelle (zwischen 0 und restlicht Länge von src) entfernt und ans Ende von dest gehängt
		{
